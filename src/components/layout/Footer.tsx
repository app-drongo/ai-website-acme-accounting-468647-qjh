...
const DEFAULT_FOOTER = {
  logoText: 'Acme Accounting',
  companyDescription:
    'Providing comprehensive accounting and financial services to small businesses and entrepreneurs. Trusted by over 500 clients for accurate bookkeeping, tax preparation, and financial consulting.',
  contactEmail: 'info@acmeaccounting.com',
  contactPhone: '+1 (555) 234-5678',
  contactAddress: '456 Financial Plaza, Suite 200, Business District',
  newsletterTitle: 'Financial Updates',
  newsletterPlaceholder: 'Enter your email for tax tips',
  newsletterDisclaimer:
    'Get monthly tax tips and financial insights. No spam, unsubscribe anytime.',
  section1Title: 'Services',
  section2Title: 'Company',
  section3Title: 'Resources',
  section4Title: 'Legal',
  copyrightText: '© 2024 Acme Accounting. All rights reserved.',
  madeWithText: 'by our financial experts',
  socialText: 'Connect with us:',
  social1Href: 'https://twitter.com/acmeaccounting',
  social2Href: 'https://facebook.com/acmeaccounting',
  social3Href: 'https://instagram.com/acmeaccounting',
  social4Href: 'https://linkedin.com/company/acmeaccounting',
  social5Href: 'https://github.com/acmeaccounting',
} as const;
...
export default function Footer(props: FooterProps) {
  ...
  const footerSections = [
    {
      ...
      links: [
        ...
        { name: 'Payroll Services', href: '/payroll', editableId: 'link-footer-payroll' },
        {
          ...
          editableId: 'link-footer-financial-planning',
        },
        { name: 'Business Consulting', href: '/consulting', editableId: 'link-footer-consulting' },
        { name: 'Audit Support', href: '/audit-support', editableId: 'link-footer-audit-support' },
      ],
    },
    {
      ...
      links: [
        ...
        { name: 'Our Team', href: '/team', editableId: 'link-footer-team' },
        {
          ...
          editableId: 'link-footer-success-stories',
        },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Financial Tools', href: '/tools', editableId: 'link-footer-tools' },
        {
          name: 'Knowledge Base',
          href: '/knowledge-base',
          editableId: 'link-footer-knowledge-base',
        },
        { name: 'Tax Forms', href: '/tax-forms', editableId: 'link-footer-tax-forms' },
    ...
    },
    {
      ...
      links: [
        ...
        { name: 'Client Agreement', href: '/agreement', editableId: 'link-footer-agreement' },
      ],
    },
  ];
  ...
  const bottomLinks = [
    ...
    { name: 'Client Support', href: '/client-support', editableId: 'link-footer-client-support' },
  ];
