...
const DEFAULT_HERO = {
  ...
  titleHighlight: 'Smart Accounting Software',
  description:
    'Automate bookkeeping, track expenses, and generate financial reports in minutes. Built specifically for small businesses and entrepreneurs who need professional accounting without the complexity.',
  features: [
  ...
  imageAlt: 'Acme Accounting dashboard showing financial reports',
