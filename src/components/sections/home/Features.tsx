...
const DEFAULT_FEATURES = {
  badge: 'Core Features',
  mainTitle: 'Complete Accounting Solution',
  mainTitleHighlight: 'Built for Small Business Success',
  mainDescription:
    'Streamline your financial operations with our comprehensive accounting software designed specifically for small businesses and entrepreneurs.',
  ...
  feature3Description:
    'Manage your finances on-the-go with our mobile app for expense tracking, invoice creation, and financial reporting.',
  feature3Badge: 'Mobile',
  feature4Title: 'Multi-Business Management',
  feature4Description:
    'Handle multiple business entities, separate books, and consolidated reporting from a single dashboard.',
  feature4Badge: 'Multi-Entity',
  feature5Title: 'Advanced Financial Reports',
  feature5Description:
    'Generate profit & loss statements, balance sheets, and cash flow reports with 40+ customizable templates.',
  feature5Badge: 'Reporting',
  feature6Title: 'Automated Workflows',
  feature6Description:
    'Set up recurring invoices, payment reminders, and expense approvals to save time on routine tasks.',
  feature6Badge: 'Automation',
  feature7Title: 'Bank & App Integrations',
  feature7Description:
    'Connect seamlessly with 12,000+ banks and popular business apps like PayPal, Stripe, and QuickBooks.',
  feature7Badge: 'Integration',
  feature8Title: 'Expert Accounting Support',
  feature8Description:
    'Get help from certified bookkeepers and tax professionals with unlimited chat and phone support.',
  feature8Badge: 'Support',
  feature9Title: 'Data Security & Backup',
  feature9Description:
    'Your financial data is protected with bank-level encryption, daily backups, and SOC 2 compliance.',
