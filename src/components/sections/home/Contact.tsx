...
const DEFAULT_CONTACT = {
  ...
  mainTitle: 'Ready to Simplify Your',
  mainTitleHighlight: 'Business Accounting?',
  mainDescription:
    'Join thousands of small business owners who trust Acme Accounting to manage their finances. Our team is here to help you get started and answer any questions.',
  ...
  companyPlaceholder: "Johnson's Bakery LLC",
  messageLabel: 'Tell us about your business *',
  messagePlaceholder:
    'What type of business do you run? How many transactions per month? Any specific accounting needs?',
} as const;
